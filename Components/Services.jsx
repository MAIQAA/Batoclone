...
const Services = () => {
  ...
  return (
    <div className="relative flex justify-between text-white pb-16 xl:pt-40 md:pt-32 pt-28 lg:px-16 md:px-10 px-5">
      {/* Left Section */}
      <div className="static w-[40%] space-y-10 ">
        ...
        <Image src="/clutch3.png" width={120} height={50} alt="clutch rating" />
      </div>
      ...
      <div className="w-[55%] relative ">
        <div className="grid gap-5 services">
          {items.map((item) => (
            <h1
              key={item.id}
              className="services relative flex justify-between items-center overflow-hidden p-4 xl:p-7 border border-gray-400 bg-[#050505] xl:text-3xl text-lg z-10 text-white group"
            >
